...
<style>
  ...
  .card{width:1200px;height:630px;background:#1E1B17;display:flex;align-items:center;
  ...
  .rule{position:absolute;top:0;left:0;right:0;height:4px;
        background:linear-gradient(90deg,rgba(201,168,76,.35),#C9A84C 50%,rgba(201,168,76,.35));}
  ...
  .eyebrow{color:#C9A84C;font-size:15px;letter-spacing:4px;text-transform:uppercase;font-weight:600;margin:0;}
  h1{margin:0;color:#fff;font-size:62px;line-height:1.02;letter-spacing:-2px;font-weight:600;}
  p{margin:0;color:#A8A29E;font-size:22px;line-height:1.45;max-width:520px;}
  ...
  .mark span{color:#C9A84C;}
  .dot{width:4px;height:4px;background:rgba(201,168,76,.5);}
  .url{font-size:17px;color:rgba(168,162,158,.8);}
</style></head><body>
  <div class="card">
    <div class="rule"></div>
